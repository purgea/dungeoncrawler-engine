                ...
                [
                    ...
                    'data' => [
                        ...
                        'layout' => [
                            ...
                            'ramp_count_min' => 1,
                            'ramp_count_max' => 3,
                            'gateway_height_min' => 3,
                            'gateway_height_max' => 7,
                            'gateway_width_min' => 3,
                            'gateway_width_max' => 5,
                            'floor_elevation_step' => 10,
                            'start_floor' => 0,
                            'max_slope' => 60,
                        ],
                        'rooms' => [
                        ...
                        'population' => [
                            'random_salt' => 1103527597,
                            'safe_distance' => 4,
                            'guard_distance' => 4,
                            'floor_diversity_bonus' => 0.25,
                            'enemy_spacing' => 3,
                            'exit_distance_minimum' => 3,
                            'warden_id' => 'warden',
                            'sigil_id' => 'sigil',
                            'enemy_count' => [
                                'minimum' => 6,
                            ...
                            'trap' => [
                                'wall_mount' => 'wall',
                                'wall_limit_divisor' => 3,
                                'wall_limit_minimum' => 1,
                                'spike_id' => 'spikes',
                                'phase_minimum' => 0,
                                'phase_maximum' => 4000,
                                'phase_scale' => 1000,
