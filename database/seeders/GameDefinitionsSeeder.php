...
final class GameDefinitionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $definitions = [
            ...
            'trap' => [
                ['slug' => 'spikes', 'sort_order' => 1, 'data' => ['name' => 'Rising Spikes', 'damage' => 22, 'mount' => 'floor', 'color' => [0.48, 0.49, 0.46], 'warning_color' => [0.44, 0.12, 0.03], 'period' => 2.15]],
                ['slug' => 'wall_head', 'sort_order' => 2, 'data' => ['name' => 'Flame Sentinel', 'damage' => 18, 'color' => [1, 0.16, 0.02], 'warning_color' => [1, 0.38, 0.04], 'period' => 1, 'projectile_speed' => 18, 'mount' => 'wall']],
            ],
        ];
