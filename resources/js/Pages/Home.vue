...
import { ref } from 'vue';
import { readCheckpoint, clearCheckpoint } from '../game/RunState.js';
...
<template>
    <main class="title-screen">
        ...
        <footer class="title-footer"><span>WASD MOVE <b>·</b> MOUSE AIM & FIRE <b>·</b> SHIFT SPRINT</span><span>HEADPHONES RECOMMENDED</span></footer>
    </main>
</template>
<style scoped>
